  ...
  return (
    <GlassCard>
      <div className="flex items-center gap-1.5 mb-3">
        ...
        <SampleMark note="Estimated — projected from gap/quick-win remediation lift, not a scan measurement." />
      </div>
      <TrendLineChart
        data={data}
        xKey="label"
      ...
      <p className="text-[10px] text-sf-muted/70 mt-2">
        Based on best practices and similar org remediation outcomes.
      </p>
    </GlassCard>
  );
}
